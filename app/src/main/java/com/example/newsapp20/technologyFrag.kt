...
class technologyFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.techRecycler)
    ...
    fun fetchData(view : View){
        ...
        val url = "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=4c35a647251a46459d87c7a58db12aaa"
